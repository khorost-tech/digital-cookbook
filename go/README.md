...
| [`concurrency/`](concurrency/) | Конкурентность в Go: горутины/каналы, sync, модель памяти, паттерны, отладка гонок | 🔜 скоро |
| [`context/`](context/) | Контекст в Go: отмена, дедлайны, WithCancelCause, request-scoped values | 🔜 скоро |
...
| [`testing/`](testing/) | Тестирование в Go: ручные фейки, httptest, интеграционные тесты через testcontainers-go (Postgres + Redis), детектор гонок | 🔜 скоро |
