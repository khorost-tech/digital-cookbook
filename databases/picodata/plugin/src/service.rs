...
use crate::handlers::endpoints::top_products::register_top_products_handle;
...
impl Service for ExampleService {
    ...
    fn on_start(&mut self, context: &PicoContext, config: Self::Config) -> CallbackResult<()> {
        ...
        log::warn!("Registering RPC handle /top_products");
        register_top_products_handle(context);
