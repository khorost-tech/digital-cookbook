...
6. [Мониторинг (Grafana)](#мониторинг-grafana)
...
Это ожидаемое поведение. В `rabbitmq.conf` задана стратегия `pause_minority`: при потере
большинства нод (2 из 3) оставшиеся ноды **намеренно останавливают** обработку запросов,
чтобы исключить split-brain. Верните хотя бы 2 ноды в строй — кластер автоматически
возобновит работу.
