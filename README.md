...
| [`opensearch/cluster`](opensearch/cluster) | 3-нодный кластер OpenSearch через официальный Ansible-плейбук: роли нод, TLS (self-signed demo вместо Vault PKI), security plugin с ролевым доступом (reader/writer/admin) | [OpenSearch: установка кластера через Ansible](https://khorost.tech/infrastructure/opensearch-cluster-ansible/) |
