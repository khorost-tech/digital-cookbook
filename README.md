...
| [`distributed-config`](distributed-config) | etcd, Consul, Vault и PostgreSQL: watch, service discovery, динамические credentials | [Распределённые конфигурации](https://khorost.tech/architecture/distributed-configuration/) |
